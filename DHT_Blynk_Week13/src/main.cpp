...
#define BLYNK_TEMPLATE_ID "TMPL6N_Nt_hKK"
#define BLYNK_TEMPLATE_NAME "DHT 1086"
#define BLYNK_AUTH_TOKEN "qL0XBzgapWGXijiddWNJa3-0_WACaefy" // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
